...
public class DailyAppsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = DailyAppsAdapter.class.getName();
    ...
    public DailyAppsAdapter(Context ctx, RecyclerView recyclerView) {
        this.ctx = ctx;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position) == Constants.ItemType.ITEM.getValue()) {
            ...
            viewHolderItem.vote.setTrackingScreen(DailyAppsFragment.TAG);
